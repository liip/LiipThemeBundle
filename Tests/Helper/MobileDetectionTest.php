...
class MobileDetectionTest extends \PHPUnit_Framework_TestCase
{

    /**
     * @covers Liip\ThemeBundle\Helper\MobileDetection::__construct
     */
    public function testConstructWithoutUserAgent()
    {
        $device = new MobileDetection('');
    ...
    /**
     * @covers Liip\ThemeBundle\Helper\MobileDetection::__call
     */
    public function testCall()
    {
        $device = new MobileDetection('Mozilla/5.0 (iPad; U; CPU OS 4_3_3 like Mac OS X; en-us) AppleWebKit/533.17.9 (KHTML, like Gecko) Version/5.0.2 Mobile/8J2 Safari/6533.18.5');
    ...
    /**
     * @covers Liip\ThemeBundle\Helper\MobileDetection::checkDevice
     * @covers Liip\ThemeBundle\Helper\MobileDetection::isTablet
     * @covers Liip\ThemeBundle\Helper\MobileDetection::getDevice
     */
    ...
    /**
     * @covers Liip\ThemeBundle\Helper\MobileDetection::checkDevice
     * @covers Liip\ThemeBundle\Helper\MobileDetection::isPhone
     * @covers Liip\ThemeBundle\Helper\MobileDetection::getDevice
     */
    public function testConstructIphone()
    {
        $device = new MobileDetection('Mozilla/5.0 (iPhone; U; CPU iPhone OS 4_3_3 like Mac OS X; en-us) AppleWebKit/533.17.9 (KHTML, like Gecko) Version/5.0.2 Mobile/8J2 Safari/6533.18.5');
    ...
    {
        $device = new MobileDetection('Mozilla/5.0 (Linux; U; Android 2.3.3; en-us; GT-I9100 Build/GINGERBREAD) AppleWebKit/533.1 (KHTML, like Gecko) Version/4.0 Mobile Safari/533.1');
    ...
    {
        $device = new MobileDetection('Mozilla/5.0 (BlackBerry; U; BlackBerry 9800; en) AppleWebKit/534.1+ (KHTML, like Gecko) Version/6.0.0.337 Mobile Safari/534.1+');
    ...
    {
        $device = new MobileDetection('Mozilla/5.0 (compatible; MSIE 9.0; Windows Phone OS 7.5; Trident/5.0; IEMobile/9.0; HTC; 7 Trophy)');
    ...
    {
        $device = new MobileDetection('Mozialla/5.0 (webOS/1.4.5; U; en-US) AppleWebKit/532.2 (KHTML, like Gecko) Version/1.0 Safari/532.2 Pre/1.0');
    ...
    {
        $device = new MobileDetection('Mozilla/5.0 (Symbian/3; Series60/5.2 NokiaN8-00/011.012; Profile/MIDP-2.1 Configuration/CLDC-1.1 ) AppleWebKit/525 (KHTML, like Gecko) Version/3.0 BrowserNG/7.2.7.2 3gpp-gba');
    ...
    {
        /**
        * Galaxy Tab gets recocnized as Phone
        */
        $device = new MobileDetection('Mozilla/5.0 (Linux; U; Android 2.2; de-de; GT-P1000 Build/FROYO) AppleWebKit/533.1 (KHTML, like Gecko) Version/4.0 Mobile Safari/533.1');
